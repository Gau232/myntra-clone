...
/*
  let selectedArray = [];
  let prevArray = [];
  prevArray = [...selectedArray];

  if(checked){
    selectedArray = [...prevArray,value]
  }else{
              ...
              <div className="catalog-filterItems">
                ...
                <li className="catalog-list-group-item">
                    <input
                      ...
                      type="radio"  value={"all"} onChange={filterByBrand} name="brandSelection"
                    />
                    All
                  </li>
                  {
                    ...
                    <input
                      className="catalog-form-check-input" name="brandSelection"
                      type="radio" value={item} onChange={filterByBrand}
                    />
                    {item}
                  </li>
                    ))
              ...
              <div className="catalog-filterItems">
                <ul className="catalog-list-group">
                  <li className="catalog-list-group-item">
                    <input
                      className="catalog-form-check-input"
                      type="radio" name="price_selection"  onClick={()=>{
              ...
              <div className="catalog-filterItems">
                <ul className="catalog-list-group">
                  <li className="catalog-list-group-item">
                    <input
                      className="catalog-form-check-input"
                      type="radio" name="discount_selection" onClick={()=>{
                        filterByDiscount(0)
                      }}
                    />
                    Show All
